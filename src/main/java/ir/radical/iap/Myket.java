 ...
 */
public class Myket extends Pay {
    // Debug tag, for logging
    // Debug tag, for logging
    static final String TAG = "Myket";
...
//                mHelper.queryInventoryAsync(mGotInventoryListener);
    ...
    public String getMarketName() {
        return mContext.getString(R.string.myket);
    }

    @Override
    public String getMarketTitle() {
        return mContext.getString(R.string.myket_title);
    }

    @Override
    public String getMarketPackage() {
        return mContext.getString(R.string.myket_package);
    }
